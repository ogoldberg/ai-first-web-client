...
| GAP-005 | Pagination API Discovery | M | In Progress | Learn that "Next page" uses API calls (/api/results?page=2), eliminate browser renders for multi-page scraping |

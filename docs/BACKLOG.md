...
| INT-013 | Appointment availability detection | M | In Progress | Detect "cita previa" and similar appointment systems. Check for available slots. Monitor for openings. Extensible to any scheduling/booking systems. |
